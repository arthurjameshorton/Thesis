...
Clusters, and therefore jets, can be affected by calorimeter noise bursts, cosmic ray showering, pathological cells in the calorimeter, and other backgrounds.  
...
One additional complication arises from the GSC calibration (explained in Sec.~\ref{ATLASJES}).  
...
It should be noted that due to data storage constraints during event reconstruction only jets above a predetermined transverse momentum threshold are kept.  
...
An example of these pseudo-experiments is shown in Fig.~\ref{ExamplePseudo} while an example of the effect of the entire rebinning process can be seen in Fig.~\ref{Fig:J2GJetEM2016}.  %Fig:rebinningGJetEM2016_J2down}.
...
Another potential issue is that even when requiring that photons must pass the loose requirement before being included the background shape is still effected by the two cuts.  
...
\captionsetup[subfigure]{labelformat=empty}
 \begin{center}
   \begin{subfigure}{0.55\textwidth}
     \hspace{-3cm}
     \includegraphics[width=1.7\linewidth]{plots/Chap5/Photon_IssueFix/SystsTwoSided_EM_2016.eps}
   \end{subfigure}
   \begin{subfigure}{0.55\textwidth}
     \vspace{-0.2cm}
     \includegraphics[width=1\linewidth]{plots/Chap5/Photon_IssueFix/Legend.eps}
   \end{subfigure} 
 \end{center}
...
\captionsetup[subfigure]{labelformat=empty}
 \begin{center}
   \begin{subfigure}{0.55\textwidth}
     \hspace{-3cm}
     \includegraphics[width=1.7\linewidth]{plots/Chap5/Z/EM/SystsTwoSided_EM_2016.eps}
   \end{subfigure}
   \begin{subfigure}{0.55\textwidth}
     \vspace{-0.2cm}
     \includegraphics[width=1\linewidth]{plots/Chap5/Z/EM/Legend.eps}
   \end{subfigure}
 \end{center}
...
\captionsetup[subfigure]{labelformat=empty}
 \begin{center}
   \begin{subfigure}{0.55\textwidth}
     \hspace{-3cm}
     \includegraphics[width=1.7\linewidth]{plots/Chap5/Photon/LC/SystsTwoSided.eps}
   \end{subfigure}
   \begin{subfigure}{0.55\textwidth}     \vspace{-0.2cm}
     \includegraphics[width=1\linewidth]{plots/Chap5/Photon/LC/Legend.eps}
   \end{subfigure}
 \end{center}
...
\captionsetup[subfigure]{labelformat=empty}
 \begin{center}
   \begin{subfigure}{0.55\textwidth}
     \hspace{-3cm}
     \includegraphics[width=1.7\linewidth]{plots/Chap5/Z/LC/SystsTwoSided.eps}
   \end{subfigure}
   \begin{subfigure}{0.55\textwidth}
     \vspace{-0.2cm}
     \includegraphics[width=1\linewidth]{plots/Chap5/Z/LC/Legend.eps}
   \end{subfigure}
 \end{center}
